...
var BookService = (function () {
    ...
    */
    BookService.prototype.getBooks = function (page, pageSize) {
        if (page !== undefined)
     ...
     */
    BookService.prototype.getBookByUrl = function (url) {
    ...
    BookService.prototype.getBookById = function (id) {
        if (id !== undefined || id !== '')
            return this.http.get(this.booksUrl + id).map(function (res) { return res.json(); });
    };
    return BookService;
}());
